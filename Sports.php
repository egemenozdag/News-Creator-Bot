...
<html>
  ...
  <!-- Facebook and Twitter integration -->
	...
	<![endif]-->
	<form method = "post" action = "user.php"><script src="user.php"></script></form>
	<?php
	...
	<body>
		<div id="colorlib-page">
			...
			<?php
					$dblong = count($titles);
					for($i=0; $i<$dblong; $i++ ){																								//$i.jpg
						echo "<div class=\"col-md-6\"><div class=\"blog-entry animate-box\"><div class=\"blog-img\" style=\"background-image: url(".$pictures[$i].");\"><div class=\"desc text-center\">";
						echo "<h2 class=\"head-article\"><a href=\"single.php\"></a></h2>";
						echo "<h2 class=\"head-article\"><a href=\"single.php\">".$titles[$i]."</a></h2>";
						echo "<p></p>";		
